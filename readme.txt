...
Software Features:
1. Send sms message to an employee
2. Reply to the message by the employee who received the call -
treated / in the process of treatment / impossible to treat
3. Management of all jobs in .csv files
4. Publishing reports (not yet built because the software is in development stages)